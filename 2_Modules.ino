...
//Blackpanel2:  BP2,
//MLX2:         Min2,Max2,
//TSL2:         IR2,Visible2,Full2,Lux2,
//VEML2:        UV2A,UV2B,
//TRIAD2:       T2xA,T2xB,T2xC,T2xD,T2xE,T2xF,T2xG,T2xH,T2xI,T2xJ,T2xK,T2xL,T2xR,T2xS,T2xT,Tx2U,T2xV,T2xW,

//ms,Hum1,Temp1,BP1,Min1,Max1,IR1,Visible1,Full1,Lux1,UV1A,UV1B,T1xA,T1xB,T1xC,T1xD,T1xE,T1xF,T1xG,T1xH,T1xI,T1xJ,T1xK,T1xL,T1xR,T1xS,T1xT,T1xU,T1xV,T1xW,BP2,Min2,Max2,IR2,Visible2,Full2,Lux2,UV2A,UV2B,T2xA,T2xB,T2xC,T2xD,T2xE,T2xF,T2xG,T2xH,T2xI,T2xJ,T2xK,T2xL,T2xR,T2xS,T2xT,T2xU,T2xV,T2xW,
...
void setup(){  
  ...
  delay(1000);
  Serial.println("ms,Hum1,Temp1,BP1,Min1,Max1,IR1,Visible1,Full1,Lux1,UV1A,UV1B,T1xA,T1xB,T1xC,T1xD,T1xE,T1xF,T1xG,T1xH,T1xI,T1xJ,T1xK,T1xL,T1xR,T1xS,T1xT,T1xU,T1xV,T1xW,BP2,Min2,Max2,IR2,Visible2,Full2,Lux2,UV2A,UV2B,T2xA,T2xB,T2xC,T2xD,T2xE,T2xF,T2xG,T2xH,T2xI,T2xJ,T2xK,T2xL,T2xR,T2xS,T2xT,TxU,T2xV,T2xW,");
 }
